...
Module.register("email",{
    ...
    getDom: function(){
		...
		//var subject = subject.substring(0,30); 
                ...
                subjectWrapper.innerHTML = subject.substring(0,15);
            ...
            wrapper.innerHTML = (this.loaded) ? "No hay emails nuevos" : this.translate("LOADING");
