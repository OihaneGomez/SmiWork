...
Module.register("calendar", {
	...
	var wrapper = document.createElement("div");
    	wrapper.className = "light small";
        	...
        	header.innerHTML = "Próximos cumpleaños";
        	wrapper.appendChild(header);
		//header.className = "small bright light";
		var events = this.createEventList();
		var wrapper2 = document.createElement("table");
		wrapper2.className = "small";

		if (events.length === 0) {
			wrapper.innerHTML = (this.loaded) ? this.translate("EMPTY") : this.translate("CARGANDO");
