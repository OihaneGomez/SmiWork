...
Module.register("weatherforecast",{
	...
	getDom: function() {
		...
		if (this.config.appid === "") {
			...
			wrapper.className = "bright bold small";
			return wrapper;
		}

		if (!this.loaded) {
			wrapper.innerHTML = this.translate("LOADING");
			wrapper.className = "bright small bold";
			return wrapper;
		}

		var table = document.createElement("table");
		table.className = "small bold bright";
	...
	getHeader: function() {
		if (this.config.appendLocationNameToHeader) {
			return  "Previsión meteorológica " + this.fetchedLocatioName;
		}
