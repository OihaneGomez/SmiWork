...
Module.register("voicecontrol", {
    ...
    getDom: function() {
		...
		wrapper.innerHTML = "Diga ESPEJO para el control por voz";
		wrapper.className = "small bright bold";
        //var header = document.createElement("header");
        //header.innerHTML = "Comandos disponibles";
...
/*
        models.forEach(function(model) {
            ...
            command.className = "small bright bold top";
